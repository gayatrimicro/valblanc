        ...
        <div class="modal-body">
          ...
          <div class="inner_enqfrm">
            <form id="frm_inq" method="post">
              ...
              <div class="form-group">
                <textarea class="form-control" rows="4" id="fmessage" name="fmessage" placeholder="Message *" required></textarea>
              </div>
              <div class="form-group text-center">
                <button type="submit" class="btn_snd">Send Message</button>
              </div>
            </form>
          </div>
        </div>
